...
var points = {
    ...
    "features":[
        ...
        {"type":"Feature","id":4,"geometry":{"type":"Point","coordinates":[-1.9828200598752457,43.315804734046424]},"properties":{"OBJECTID":6,"Name":"Basque Country","Location":"Spain","Type":"City or Region","Description":"Some of my ancestors were from here!", "ImageUrl":"images/basquecountry.jpg"}},
...
const pointsLayer = L.geoJSON(points, {
    ...
    onEachFeature: function (feature, layer) {
        layer.addEventListener("click", () => {
            layer.bindPopup(`<b>Name: </b>${feature.properties.Name}<br><b>Location: </b>${feature.properties.Location}<br><b>Type: </b>${feature.properties.Type}<br><b>Description: </b>${feature.properties.Description}<br><img class="popup-img" src="${feature.properties.ImageUrl}">`);
            // The zoom button
